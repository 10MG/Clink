...
public class FlinkSQLTest {
	...
	public static void main(String[] args) {
		StreamTableEnvironment env = ClinkContext.getOrCreateStreamTableEnvironment();
