package cn.tenmg.clink.cdc.oceanbase.debezium;
...
/**
 * 多表的从 OceanBaseRecord 对象到 {@code Flink Table & SQL} 内部数据结构的反序列化模式
 * 
 * @author June wjzhao@aliyun.com
 * 
 * @since 1.7.0
 */
public class MultiTableDebeziumDeserializationSchema implements OceanBaseDeserializationSchema<Tuple2<String, Row>> {
	...
	@Override
	public void deserialize(OceanBaseRecord record, Collector<Tuple2<String, Row>> out) throws Exception {
		RowData physicalRow;
